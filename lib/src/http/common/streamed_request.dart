...
abstract class CommonStreamedRequest extends CommonRequest implements StreamedRequest {
  ...
  StreamedHttpBody finalizeBody([body]) {
    if (body != null) {
      if (body is Stream<List<int>>) {
        ...
        throw new ArgumentError('Streamed request body must be a Stream<List<int>>.');
      }
    }
