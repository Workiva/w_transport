...
void runCommonGlobalWebSocketMonitorIntegrationTests(
  ...
  test('should support multiple monitors, each of which can be closed',
    ...
    var webSocket1 = await (connect(closeUri) as FutureOr<WebSocket>);
    ...
    var webSocket2 = await (connect(echoUri) as FutureOr<WebSocket>);
    ...
    var webSocket3 = await (connect(pingUri) as FutureOr<WebSocket>);
