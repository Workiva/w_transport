...
import 'package:w_transport/src/http/server/util.dart'
    show parseServerHeaders, progressListener;
...
class ServerWResponse extends CommonWResponse implements WResponse {
  ...
  ServerWResponse(HttpClientResponse response, Encoding this._encoding,
      ...
      : super(
            ...
            parseServerHeaders(response.headers),
            response.transform(
                progressListener(total, downloadProgressController)));
