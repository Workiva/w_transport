...
abstract class WHttp {
  ...
  static Future<WResponse> trace(Uri uri, {Map<String, String> headers}) =>
      new WRequest().trace(headers: headers, uri: uri);
