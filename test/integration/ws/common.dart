...
void runCommonWebSocketIntegrationTests(
  ...
  test('add() should send a message', () async {
    final webSocket = await (connect!(echoUri) as FutureOr<WebSocket>);
  ...
  test('should support listening to incoming messages', () async {
    final webSocket = await (connect!(pingUri) as FutureOr<WebSocket>);
    final helper = WSHelper(webSocket);
  ...
  test('should handle the server closing the connection', () async {
    final webSocket = await (connect!(closeUri) as FutureOr<WebSocket>);
  ...
  test(
      ...
      () async {
    final socket = await (connect!(closeUri) as FutureOr<WebSocket>);
