...
abstract class CommonRequest extends Object
  ...
  BaseRequest? clone() {
    ...
    if (this is FormRequest) {
      ...
      requestClone = fromClient
          ...
          : JsonRequest(transportPlatform: _transportPlatform);
    } else if (this is MultipartRequest) {
      requestClone = fromClient
          ? _wTransportClient!.newMultipartRequest()
          : MultipartRequest(transportPlatform: _transportPlatform);
    } else if (this is Request) {
      requestClone = fromClient
          ? _wTransportClient!.newRequest()
          : Request(transportPlatform: _transportPlatform);
    }
  ...
  Future<Response> delete({Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('DELETE', headers: headers, uri: uri) as FutureOr<BaseResponse>);
    assert(r is Response, 'delete() should return a Response');
    Response response = r as Response;
    return response;
  }

  @override
  Future<Response> get({Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('GET', headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> head({Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('HEAD', headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> options({Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('OPTIONS', headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> patch(
    ...
    final r = await (_send('PATCH', body: body, headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> post(
      {dynamic body, Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('POST', body: body, headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> put(
      {dynamic body, Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send('PUT', body: body, headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<Response> send(String? method,
      {dynamic body, Map<String, String>? headers, Uri? uri}) async {
    final r = await (_send(method, body: body, headers: headers, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<StreamedResponse> streamDelete(
    ...
    final r =
        await (_send('DELETE', headers: headers, streamResponse: true, uri: uri) as FutureOr<BaseResponse>);
  ...
  Future<StreamedResponse> streamGet(
      {Map<String, String>? headers, Uri? uri}) async {
    final r =
        await (_send('GET', headers: headers, streamResponse: true, uri: uri) as FutureOr<BaseResponse>);
    assert(
  ...
  Future<StreamedResponse> streamHead(
      {Map<String, String>? headers, Uri? uri}) async {
    final r =
        await (_send('HEAD', headers: headers, streamResponse: true, uri: uri) as FutureOr<BaseResponse>);
    assert(
  ...
  Future<StreamedResponse> streamOptions(
    ...
    final r = await (_send('OPTIONS',
        headers: headers, streamResponse: true, uri: uri) as FutureOr<BaseResponse>);
    assert(r is StreamedResponse,
  ...
  Future<StreamedResponse> streamPatch(
    ...
    final r = await (_send('PATCH',
        body: body, headers: headers, streamResponse: true, uri: uri) as FutureOr<BaseResponse>);
    assert(r is StreamedResponse,
